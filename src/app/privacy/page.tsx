      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="prose prose-invert prose-gold space-y-6 text-venetian-gold/80">
          ...
          <section id="poker-integrity">
            ...
            <p>Entry security checks are served and verified by our own application. Your browser solves a short computational challenge before taking a seat, with occasional refreshes between hands. The challenge is bound to your poker identity, browser cookie and site, and can only be redeemed once. No external CAPTCHA provider receives these checks. Passing a challenge does not prove a player is human or certify that subsequent poker decisions are human.</p>
