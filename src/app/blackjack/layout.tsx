...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (brand.id !== 'veilstone') return getCasinoGameMetadata(brand.id, 'blackjack')
  ...
  return {
    ...
    description:
      'Play provably fair blackjack with Zcash. Around 0.5% house edge with basic strategy. Every hand verified on the blockchain. No account required.',
    keywords: [
    ...
    openGraph: {
      ...
      description:
        'Blackjack with around 0.5% house edge. Every hand is blockchain-verified. Play with Zcash for maximum privacy.',
      url: brandUrl,
    },
  }
}
